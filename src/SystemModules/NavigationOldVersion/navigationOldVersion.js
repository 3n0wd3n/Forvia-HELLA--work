import "./navigationOldVersion.scss";
...
const navigation = function () {
	...
	const languageSelection = (module) => {
		let languageBtns = module.querySelectorAll(".language-old");
		languageBtns.forEach((languageBtn) => {
			languageBtn.addEventListener("click", (event) => {
				event.preventDefault();
				let languageVariantMenu = module.querySelector(".language-variant-old");
